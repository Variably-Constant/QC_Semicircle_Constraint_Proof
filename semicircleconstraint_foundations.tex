...
\end{equation}
using $q = \sin^2(\theta/2)$. This reflects uniform ``information density'' along the semicircle, connecting to quantum information geometry~\cite{Nielsen2010}.
...
\begin{enumerate}
    ...
    \item The Fisher information is constant along the semicircle trajectory, connecting to information-geometric structure.
